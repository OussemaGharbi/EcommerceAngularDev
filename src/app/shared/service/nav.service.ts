...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			path: '/dashboard/default', title: 'Tableau de bord', icon: 'home', type: 'link', badgeType: 'primary', active: false
		},
		{
			title: 'Produits', icon: 'box', type: 'sub', active: false, children: [
				...
				{ path: '/products/physical/product-list', title: 'List des produits', type: 'link' },
